...
LDFLAGS	:= -w -s
LDFLAGS += -X "github.com/anhnmt/drprune/internal/version.cliVersion=$(CLIENT_VERSION)"
LDFLAGS += -X "github.com/anhnmt/drprune/internal/version.builtDate=$(BUILD_DATE)"
LDFLAGS += -X "github.com/anhnmt/drprune/internal/version.builtBy=makefile"
LDFLAGS += -X "github.com/anhnmt/drprune/internal/version.commit=$(GIT_COMMIT)"
LDFLAGS += -X "github.com/anhnmt/drprune/internal/version.commitShort=$(GIT_SHORT_COMMIT)"
LDFLAGS += -X "github.com/anhnmt/drprune/internal/version.commitBranch=$(GIT_BRANCH)"
LDFLAGS += -X "github.com/anhnmt/drprune/internal/version.goVersion=$(GO_VERSION)"
